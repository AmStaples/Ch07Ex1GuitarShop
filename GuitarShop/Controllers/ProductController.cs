...
namespace GuitarShop.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult List(string id = "All")
        {
            ...
            {
                products = context.Products.Where(p => p.Category.Name == "Guitars").OrderBy(p => p.ProductID).ToList();
                List<Product>basses = context.Products.Where(p => p.Category.Name == "Basses").OrderBy(p => p.ProductID).ToList();
                products.AddRange(basses);
